...
export function AgentConfig() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("mechaforge_config_updated", loadConfig)
    return () => {
      window.removeEventListener("mechaforge_config_updated", loadConfig)
    }
  }, [])
  ...
  const handleEnvVarChange = (key: string, value: string) => {
    ...
    setConfig(updated)
    localStorage.setItem("mechaforge_agent_config", JSON.stringify(updated))
  }
